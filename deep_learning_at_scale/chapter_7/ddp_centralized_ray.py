...
__all__ = ["centralized_ddp_ray"]

# Just log deplication
os.environ["RAY_DEDUP_LOGS"] = "0"

"""
    time deep-learning-at-scale chapter_7 ddp-centralized-ray train --world-size 3 
    time deep-learning-at-scale chapter_7 ddp-centralized-ray train --world-size 6  
"""

centralized_ddp_ray = typer.Typer(no_args_is_help=True, pretty_exceptions_enable=False)
...
def train(
    ...
    results = [
        run_worker.remote(rank, world_size, master_address, master_port)
